...
CREATE FUNCTION test_process_templates_textarray() RETURNS SETOF TEXT AS $$ BEGIN
    ...
    RETURN NEXT is(
        process_templates(
            ...
            '{ "i":42, "f":"42.0", "sci":0.314e3, "s":"oops", "true":true, "false":false, "null": null }'
        ),
        array[
            'i:42,f:42.0,sci:314',
            NULL,
...
CREATE FUNCTION test_process_templates_text() RETURNS SETOF TEXT AS $$ BEGIN
